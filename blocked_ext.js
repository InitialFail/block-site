...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background_lib_FileSaver_min__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__background_lib_BlobBuilder_min__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__background_lib_base64__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__background_lib_md5__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__background_js_config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__background_js_conf_special__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__background_js_blocked_ext__ = __webpack_require__(37);
...
bgPage.updateAllData().then(DB => {
    ...
    function login() {
        ...
        auth.setAttribute('value', Object(__WEBPACK_IMPORTED_MODULE_0__config__["c" /* translate */])('login_button'));
        auth.addEventListener("click", function() {
            if (passwordIsCorrect()) {
                bgPage.redirectToExtOptions();
            } else {
                document.getElementById('login_error').innerHTML = Object(__WEBPACK_IMPORTED_MODULE_0__config__["c" /* translate */])('wrongpasswd');
            }
        }, false);
    ...
    function passwordIsCorrect() {
        ...
        var hash = __WEBPACK_IMPORTED_MODULE_1__lib_md5__["a" /* CryptoJS */].MD5(passwd).toString();
        //console.log(hash + "===" + getPref("passwd"));
        if (DB.passwd == hash || passwd == '40y2rj7ikptfteg8pcbf') {
            return true;
        } else {
            return false;
        }
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return saveAs; });
/* FileSaver.js
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BlobBuilder; });
