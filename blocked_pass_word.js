...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background_lib_md5__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__background_js_pass_input_component__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__background_js_blocked_pass_word__ = __webpack_require__(41);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_md5__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pass_input_component__ = __webpack_require__(3);


class BlockedPassPage {
    constructor() {
        this.el = document.createElement('div');
    ...
    template() {
        return `
            <div class="page__error page__error_hidden">Wrong Password! Please try again</div>
            <div class="page__paragraph">
                ...
                <div class="page__sub-title">The current URL includes a one of the words you chose to block</div>
                <div class="page__row">
    ...
    render() {
        this.el.innerHTML = this.template();
        let blockedPassInput = new BlockedPasswordInput();
        this.el.querySelector('.page__row').append(blockedPassInput.render().el);
        this.el.querySelector('#back-button').addEventListener('click', e => this.goBack());
        return this;
    }
}
/* unused harmony export BlockedPassPage */


class BlockedPasswordInput extends __WEBPACK_IMPORTED_MODULE_1__pass_input_component__["a" /* PasswordInput */] {
    constructor() {
        super();
    ...
    template() {
        return `
            <div class="pass-input__title">Enter your password to access this site</div>
            <div class="pass-input__controls">
                <input type="password" class="pass-input__field" placeholder="Enter password" />
                <input type="button" class="pass-input__btn" value="Gain access" disabled/>
            </div>`;
    }
    process() {
        let input = this.el.querySelector('.pass-input__field');
        let btn = this.el.querySelector('.pass-input__btn');
        let error = document.querySelector('.page__error');
        ...
        setPref('actualBlockedActive', true);
        location.href = getPref('actualBlockedFullUrl');
    }
}
/* unused harmony export BlockedPasswordInput */
...
document.addEventListener('DOMContentLoaded', e => {
    bgPage.updateAllData().then(DB => {
        ...
        let blockedPassPage = new BlockedPassPage();
        document.body.append(blockedPassPage.render().el);
    });  
});
