...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background_js_blocked_word__ = __webpack_require__(43);
...
class BlockedPage {
    ...
    render() {
        ...
        this.el.querySelector('#settings-button').addEventListener('click', e => this.goSettings());
        return this;
    }
}
